...
<body>
      ...
      <div class="col">
        <div class="card mb-4 rounded-3 shadow-sm">
          ...
          <img src="./img/reception.JPG" alt="" class="img-thumbnail">
            <ul class="list-unstyled mt-3 mb-4"><hr>
    ...
    <a class="btn btn-lg btn-primary" href="/docs/5.3/components/navbar/" role="button"> »</a>
    <!-- <p id="countdown">23:59</p> -->
    </div>
    <br><br>
    <h2 class='text-center mb-5 fw-bold'>Услуги</h2>
    <hr>
    <div class="bg-body-tertiary bottom-50 p-5 rounded ">
    <h1><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">Расслабляющий массаж</font></font></h1>
    <hr>
    <p class="lead"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">Для психического здоровья и улучшения общего самочувствия после тяжелых жизненных нагрузок.</font></font></p>
  ...
  <div class="bg-body-tertiary p-5 rounded">
    <h1><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">Ароматический масляный массаж</font></font></h1>
    <hr>
    <p class="lead"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">Ойл массаж позволяет достичь омолаживающий и антицеллюлитный эффект, и так же избавиться от различных проблем и заболеваний.</font></font></p>
        <ul class='service__pricelist'>
  ...
  <br>
  <div class="bg-body-tertiary p-5 rounded">
    <h1><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">Стоун-терапия</font></font></h1>
    <hr>
    <p class="lead"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">Для этого вида массажа применяются специальные камни вулканических пород,
                            которые нагреваются до определенной температуры (40-50 градусов). В них содержится множество
                            полезных веществ, включая железо и магний.</font></font></p>
        <ul class='service__pricelist'>
  ...
  <br>
  <div class="bg-body-tertiary p-5 rounded">
    <h1><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">Спортивный массаж</font></font></h1>
    <hr>
    <p class="lead"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">Техника спортивного массажа особенно рекомендована тем, кто ведет активный
                            образ жизни, регулярно испытывает физические нагрузки. Массажные манипуляции помогут снизить боль,
                            расслабить мышцы, нормализировать кровообращение и лимфопоток.</font></font></p>
        <ul class='service__pricelist'>
